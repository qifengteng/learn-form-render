        ...
        return {
            ...
            methods: {
                buildOriginRender(field) {
                    ...
                    this.modelValue = isDef(this.modelValue)
                        ? this.modelValue
                ...
                async loadOptions() {
                    ...
                    if (Array.isArray(options)) {
                        ...
                        if (options.isDynamic) {
                            ...
                            this.options = [];
                            try {
                                const loadApi = this.field.options.loadOptions || store.loadOptions
                                const res = await loadApi(this.field);
                ...
                setValue(newVal) {
                    this.modelValue = isFunction(this.field.setValue)
